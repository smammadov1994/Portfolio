...
const ArtifactOverlay = ({ isOpen, onClose, artifact }) => {
                ...
                return (
                    <div className="artifact-project-view">
                        ...
                        <div className="project-details">
                            <img src={artifact.data?.image} alt={artifact.data?.title} className="artifact-hero-image" />
                            <p className="artifact-description">{artifact.data?.description}</p>
                            ...
                            <div className="artifact-actions">
                                <button className="action-btn primary" onClick={() => window.open(artifact.data?.githubUrl, '_blank')}>
                                    View Code
                                </button>
    ...
    return (
        <div className={`artifact-overlay-backdrop ${shouldAnimate ? 'open' : ''}`} onClick={onClose}>
            <div 
